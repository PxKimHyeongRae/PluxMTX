...
//go:embed dashboard_webrtc.html
var dashboardWebRTCHTML []byte

//go:embed dashboard_hls.html
var dashboardHLSHTML []byte
...
func (s *httpServer) onRequest(ctx *gin.Context) {
	...
	if ctx.Request.Method == http.MethodGet {
		...
		case ctx.Request.URL.Path == "/dashboard" || ctx.Request.URL.Path == "/dashboard/":
			ctx.Header("Cache-Control", "no-cache")
			ctx.Header("Content-Type", "text/html")
			ctx.Writer.WriteHeader(http.StatusOK)
			ctx.Writer.Write(dashboardWebRTCHTML)

		case ctx.Request.URL.Path == "/dashboard-hls" || ctx.Request.URL.Path == "/dashboard-hls/":
			ctx.Header("Cache-Control", "no-cache")
			ctx.Header("Content-Type", "text/html")
			ctx.Writer.WriteHeader(http.StatusOK)
			ctx.Writer.Write(dashboardHLSHTML)

		case ctx.Request.URL.Path == "/ptz" || ctx.Request.URL.Path == "/ptz/":
			ctx.Header("Cache-Control", "no-cache")
			ctx.Header("Content-Type", "text/html")
			ctx.Writer.WriteHeader(http.StatusOK)
			ctx.Writer.Write(ptzHTML)
